...
?>
  ...
  <head>
    ...
    <link
      rel="preload"
      href="../assets/js/appb222.js?v=214a6e5c0e"
      as="script"
    />
  ...
  <body class="page-template page-privacy">
    <header class="m-header js-header">
      <div class="m-mobile-topbar" data-aos="fade-down">
        ...
        <button
          class="m-icon-button in-mobile-topbar js-open-search"
          ...
          <div class="l-wrapper">
            <div class="m-nav js-main-nav">
              ...
              <div class="m-nav__right">
                <button
                  class="m-icon-button in-menu-main js-open-search"
                  aria-label="Open search"
                >
                  <span class="icon-search" aria-hidden="true"></span>
                </button>
    ...
    <main class="main-wrap">
      <section class="m-hero no-picture" data-aos="fade">
        <div class="m-hero__content" data-aos="fade-down">
          <h1 class="m-hero-title bigger" style="font-family: Orion">
            Privacy
          </h1>
        </div>
      </section>
          ...
          >
            <div class="l-post-content">
              <div class="pos-relative js-post-content">
                <h1>
                  Privacy Policy for Athena
                </h1>
                <p>
                  At Athena, accessible from athena-dbms.42web.io,
                  one of our main priorities is the privacy of our visitors.
                  This Privacy Policy document contains types of information
                  that is collected and recorded by Athena and how
                  we use it.
                </p>
                <p>
                ...
                <p>
                  ...
                  information, including items such as name, phone number,
                ...
                <p>
                  Athena follows a standard procedure of using log
                ...
                <p>
                  Like any other website, Athena uses cookies.
                ...
                <p>
                  Athena's Privacy Policy does not apply to other
                ...
                <h2
                  id="ccpa-privacy-rights-do-not-sell-my-personal-information"
                >
                ...
                <h2 id="gdpr-data-protection-rights">
                ...
                <p>
                  Athena does not knowingly collect any Personal
