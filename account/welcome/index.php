...
session_destroy();
    ...
    <link rel="stylesheet" href="https://pdc-fallsem.42web.io/css/style.css" />
    <script src="https://kit.fontawesome.com/64d58efce2.js" crossorigin="anonymous"></script>
    <script>
        Swal.fire({
...
?>
    ...
    <div class="loaderwww">
        <img src="https://pdc-fallsem.42web.io/account/img/welcome.png" alt="Welcome!!" class="img-fluid">
    </div>
    <?php
    }
...
?>
    <script>
        Swal.fire({
            ...
            .then((value) => {
                location.href = 'https://pdc-fallsem.42web.io/account/welcome/index.php#mypost'
            });
    </script>
    <?php
    }
...
?>
    ...
    if(md5($_POST['old_pass']) != $fetch_info['codekey'] || $check == false){
?>
    <script>
        Swal.fire({
                title: '#ERROR !!',
    ...
    <section class="py-5 my-5">
        <div class="container">
            <div class="shadow rounded-lg d-block d-sm-flex"
                style="background: rgba( 255, 255, 255, 0.93); background-image: url('https://pdc-fallsem.42web.io/account/img/logo.png'); background-blend-mode: overlay; background-size: contain; background-position: center;  background-repeat: no-repeat;">
                <div class="profile-tab-nav border-right">
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="addpost-tab" data-toggle="pill" href="#addpost" role="tab"
                            aria-controls="addpost" aria-selected="false">
                        ...
                        <?php if($fetch_info['role_2'] == "Admin" ){ ?>
                        <a class="nav-link" id="visitors-tab" data-toggle="pill" href="#visitors" role="tab"
                            aria-controls="visitors" aria-selected="false">
                            <i class="fa fa-user text-center mr-1"></i>
                            Manage Visitors
                        </a><?php } ?>
                        <?php if($fetch_info['role_2'] == "Admin" ){ ?>
                        <a class="nav-link" id="dbback-tab" data-toggle="pill" href="#dbback" role="tab"
                            aria-controls="dbback" aria-selected="false">
                        ...
                        <a class="nav-link" id="mypost-tab" data-toggle="pill" href="#mypost" role="tab"
                            aria-controls="mypost" aria-selected="false">
                            <i class="fa fa-code text-center mr-1"></i>
                            My Posts
                        </a>
                        <a class="nav-link" id="managecomment-tab" data-toggle="pill" href="#managecomment" role="tab"
                            aria-controls="managecomment" aria-selected="false">
                            <i class="fa fa-sitemap" text-center mr-1"></i>
                            Manage Comments
                        </a>
                        <a class="nav-link" id="bookmark-tab" data-toggle="pill" href="#bookmark" role="tab"
                            aria-controls="bookmark" aria-selected="false">
                            <i class="fa fa-sitemap" text-center mr-1"></i>
                            Manage Bookmarks
                        </a>
                        ...
                        <?php if($fetch_info['role_2'] == "Admin" || $fetch_info['role_2'] == "Editor"){ ?>
                        <a class="nav-link" id="managecat-tab" data-toggle="pill" href="#managecat" role="tab"
                            aria-controls="managecat" aria-selected="false">
                            <i class="fa fa-sitemap" text-center mr-1"></i>
                            Manage Categories
                        </a><?php } }?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Username: <button disabled="true"
                                                style="cursor: not-allowed;  color: #fff; width: auto; height; auto; display: inline; border-radius: 10px; background: #17a2b8; font-size: 1.1rem; margin: 1px; padding: 6px 30px 6px 25px; border:0px;"><b><?php echo '@'.$fetch_info['username']; ?></b></button></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off"
                                            name="form1-update-author"
                                            value=<?php echo '"'.$fetch_info['author'].'"'; ?> required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off"
                                            name="form1-update-name"
                                            value=<?php echo '"'.$fetch_info['fullname'].'"'; ?> required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" autocomplete="off"
                                            name="form1-update-email" value=<?php echo '"'.$fetch_info['email'].'"'; ?>
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" autocomplete="off"
                                                name="form1-update-phone"
                                                value=<?php echo '"'.explode("-",$fetch_info['phone'])[1].'"'; ?>
                                                required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off"
                                            name="form1-update-photo" value=<?php echo '"'.$fetch_info['photo'].'"'; ?>>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Role</label>
                                        <input type="text" class="form-control" autocomplete="off"
                                            value=<?php echo '"'.$fetch_info['role_2'].'"'; ?> disabled="true">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="form1-update-bio" rows="4"
                                            placeholder="Tell Us More About You !! "><?php echo $fetch_info['bio']; ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <style>
                                    ...
                                    <table>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="github" id="github"
                                                        value="<?=$fetch_info['github']?>"
                                                        placeholder="Github Username">
                                                </div>
                                            </td>
                                            <td><label class="col-sm-2.8 col-form-label" style="margin: 7px;"><i
                                                        class="fa fa-instagram"></i> Instagram:</label></td>
                                            <td>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                    ...
                                                    <input type="text" class="form-control" name="instagram"
                                                        id="instagram" value="<?=$fetch_info['instagram']?>"
                                        ...
                                        <tr>
                                            <td> <label class="col-sm-2.8 col-form-label"><i class="fa fa-linkedin"></i>
                                                    LinkedIn:</label></td>
                                            <td> <input type="text" class="form-control" name="linkedin" id="linkedin"
                                                    value="<?=$fetch_info['linkedin']?>"
                                                    placeholder="LinkedIn Profile URL"></td>
                                        ...
                                        <tr>
                                            <td> <label class="col-sm-2.8 col-form-label"><i class="fa fa-facebook"></i>
                                                    Facebook:</label></td>
                                            <td> <input type="text" class="form-control" id="facebook" name="facebook"
                                                    value="<?=$fetch_info['facebook']?>"
                                                    placeholder="Facebook Profile URL"></td>
                                            <td><label class="col-sm-2.8 col-form-label"><i class="fa fa-globe"></i>
                                                    Website:</label></td>
                                            <td><input type="text" class="form-control" id="website" name="website"
                                                    value="<?=$fetch_info['website']?>" placeholder="Website URL"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                        ...
                        <form action=" " method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control pd2-password-validation"
                                            name="old_pass" autocomplete="off" required />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control pd-password-validation"
                                            name="new_pass" autocomplete="off" required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control pd1-password-validation"
                            ...
                            <div>
                                ...
                                <a href="https://pdc-fallsem.42web.io/account/welcome/index.php"><button type="button"
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            ...
                                                            <?php if($user['role_2'] != "Contributor"){ ?><a
                                                                style="text-decoration:none;"
                                                                href="manageusers.php?encryption_id=<?=$user['username']?>&role=Contributor"><button
                                                                    class="dropdown-item" type="submit" name="contributor">Role:
                                                                    Contributor</button></a><?php } ?>
                                                            <?php if($user['role_2'] != "Editor"){ ?><a
                                                                style="text-decoration:none;"
                                                                href="manageusers.php?encryption_id=<?=$user['username']?>&role=Editor"><button
                                                                class="dropdown-item" type="submit" name="editor">Role:
                                                                Editor</button></a><?php } ?>
                                                            <?php if($user['role_2'] != "Admin"){ ?><a
                                                                style="text-decoration:none;"
                                                                href="manageusers.php?encryption_id=<?=$user['username']?>&role=Admin"><button
                                                                class="dropdown-item" type="submit" name="admin">Role:
                                                                Administrator</button></a><?php } ?>
                                                            <?php if($user['role_1'] != "inactive"){ ?><a
                                                                style="text-decoration:none;"
                                                                href="manageusers.php?encryption_id=<?=$user['username']?>&role=block"><button
                                                                class="dropdown-item" type="submit" name="block">Account:
                                                                Block</button></a><?php } ?>
                                                            <?php if($user['role_1'] != "active"){ ?><a
                                                                style="text-decoration:none;"
                                                                href="manageusers.php?encryption_id=<?=$user['username']?>&role=unblock"><button
                                                                class="dropdown-item" type="submit" name="unblock">Account:
                                                                Unblock</button></a><?php } ?>
          ...
          ?>
                    ...
                    <div class="tab-pane fade" id="visitors" role="tabpanel" aria-labelledby="visitors-tab">
                        ...
                        <div class="btn-group"><a href="https://pdc-fallsem.42web.io/account/FPDF/tuto5.php" style="color: #fff;" class="btn btn-success"><b><?="Generate Authenticated Report"?></b></a></div><br><br>
                        <div class="row" style="overflow-y:auto; height: 550px;">
                            <div class="col-lg-12">
                                <section class="panel">
          ...
          foreach($visitors as $visitor){
            ?>
                                            <tr>
                                                <td><div class="btn-group"><a style="color: #fff;" class="btn btn-info"><?="IP Address: "?><b><?=$visitor['ip_address']?></b></a></div>
                                                <br><?="MAC Address: ".$visitor['mac_address']?></td>
                                                <td><?=$visitor['link']?></td>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" id="colFormLabel"
                                                        value="<?=$fetch_info['author']?>" disabled="true">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <input type="text" class="form-control" id="colFormLabel"
                                                        value="<?=$date->format('d/m/Y')?>" disabled="true">
                                                </div>
                                            </div>
                                            <br><br>
                                            <input type="submit" name="add_submit" class="btn btn-success"
                                                value="Submit">
                                            <input type="submit" name="add_draft" class="btn btn-primary"
                                                value="Save as Draft">
                                            <input type="button" name="add_cancel" class="btn btn-secondary"
                                                value="Cancel">
                                        </form>
                                    </div>
                                </div>
...
<div class="tab-pane fade" id="dbback" role="tabpanel" aria-labelledby="dbback-tab">
                        <h3 class="mb-4" style="font-family: Orion;">Database Backup</h3>
                        <div class="col-lg-12">
                            <section class="panel">
                                <div class="panel-body">
<?php 
...
?>
<a class="btn btn-primary" href="backup/arms.sql" download>Download</a>
<?php
}
else{
?>
<form action="" method="POST">
<button type="submit" name="dbbackup" class="btn btn-danger">Perform Database Backup </button>
</form>
<?php
}
?>
<br><hr style="border: 2px solid #000;">
                                </div>
                            </section>
                        </div>
                        </div>
          ...
          foreach($posts as $post){
            ?>
                                            <tr>
                                            <?php $prev_link = "https://pdc-fallsem.42web.io/preview.php?post_link=".$post['id']; ?>
                                                <td><?=$post['title']?></td>
                                                <td><?=$post['status']?></td>
                                                <td><?=$post['reason']?></td>
                                                <td style="width: 290px;">
                                                    <div class="btn-group">
                                                        <a class="btn btn-success"
                                                            href=<?php echo '"'.$prev_link.'"'; ?> >View</a>
                                                   
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-info <?=(($post['status']!='Draft')?'disabled':'')?>"
                                                            href="?send_successful=<?=$post['id']?>&encryption_id=<?=$fetch_info['username']?>">Send<i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-primary <?=(($post['status']!='Draft')?'disabled':'')?>"
                                                            href="editpost.php?encryption_post=<?=$post['id']?>">Edit<i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger <?=((($post['status']=='Published') || ($post['status']=='In Review'))?'disabled':'')?>"
                                                            href="removepost.php?retract_post=<?=$post['id']?>&encryption_id=<?=$fetch_info['username']?>"><?=((($post['status']=="In Review") || ($post['status']=="Pending"))?"Retract":"Delete")?><i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
 ...
 <?php $prev_link = "https://pdc-fallsem.42web.io/preview.php?post_link=".$post['id']; ?>
                                                ...
                                                <td style="width: 290px;">
                                                    ...
                                                    <div class="btn-group">
                                                        <a class="btn btn-primary <?=(($post['status']!='Draft')?'disabled':'')?>"
                                                            href="../includes/removepost.php?id=<?=$post['id']?>">Edit<i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger <?=((($post['status']=='Published') || ($post['status']=='In Review'))?'disabled':'')?>"
  ...
  <?php $prev_link = "https://pdc-fallsem.42web.io/preview.php?post_link=".$post['id']; ?>
    ...
    if ( window.history.replaceState ) {
        window.history.replaceState( null, null, window.location.href );
                                                        ...
                                                        <button
                                                                name="comment-tag-1" id="comment-tag-1" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px; font-size: 0.85rem; margin: 8px; font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #737679; background: #393c41; color: #ffffff;">Approved</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-2" id="comment-tag-2" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px; font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #686b39; background: #343726; color: #e5e566;">Improvement</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-3" id="comment-tag-3" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px; font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #653b1a; background: #342215; color: #ffa860;">Best</span>
                                                                </button>

                                                        <button
                                                                name="comment-tag-4" id="comment-tag-4" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px; font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #724246; background: #38151a; color: #f2abab;">Hatred</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-5" id="comment-tag-5" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px;  font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #633246; background: #26111d; color: #f380a3;">Spam</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-6" id="comment-tag-6" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px; font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #5c3a67; background: #32233c; color: #c79ceb;">Enhancement</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-7" id="comment-tag-7" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px;  font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #174c72; background: #0b2337; color: #68c4fd;">Feedback</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-8" id="comment-tag-8" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px;  font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #243459; background: #0d1423; color: #638ce0;">Uplifting</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-9" id="comment-tag-9" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px;  font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #105e1a; background: #0e2717; color: #52f155;">Helpful</span>
                                                                </button>
                                                        <button
                                                                name="comment-tag-10" id="comment-tag-10" class="dropdown-item" type="submit">
                                                                <span style="padding: 3px 10px;  font-size: 0.85rem; margin: 8px;  font-weight: bolder; display: block; text-align: center; border-radius: 30px; vertical-align: middle; border: 2px solid #645b53; background: #373637; color: #ccb494;">Optimistic</span>
                                                                </button>
          ...
          ?>
                    ...
                    <div class="tab-pane fade" id="bookmark" role="tabpanel" aria-labelledby="bookmark-tab">
                        <h3 class="mb-4" style="font-family: Orion;">Manage Bookmarks</h3>
                        <div class="row" style="overflow-y:auto; height: 550px; width: auto;">
                            <div class="col-lg-12">
                                <section class="panel">
                                    <table class="table table-striped table-advance table-hover"
                                        ...
                                        <tbody>
                                            ...
                                            <?php                
          $bookmarks = getFinalBookmark($con, $email);
          if(empty($bookmarks)){?>
                                            <tr>
                                                <td colspan="4" style="text-align: center;">No Bookmarks</td>
                                            </tr>
                                            <?php }
          $count=1;
            ...
            ?>
                                            <tr>
                                                <td><?=$bookmark['title']?></td>
                                                 <td>
                                                    <div class="btn-group">
                                                        <a href="https://pdc-fallsem.42web.io/post.php?post_link=<?=$bookmark['post_id']?>" target="_blank" class="btn btn-success" style="color: #FFF;">View<i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger" style="color: #FFF;">Remove<i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" disabled
                                            value=<?php echo '"'.$fetch_info['fullname'].'"'; ?>>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value=<?php echo '"'.$fetch_info['role_2'].'"'; ?> disabled>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <i>(Ensure that the Category entered, is not already prsent in the Category
                                            ...
                                            scrutinized.)</i>
                                        <input type="text" class="form-control" autocomplete="off"
                                            name="form1-update-categname" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="required-field">Reason</label>
                                        <textarea type="text" class="form-control" name="form1-update-categreason"
                                            rows="4"
                                            placeholder="Enter a valid reason for the approving the category suggested. Mention any blog idea/topics you are planning to post under this category"
                                            required></textarea>
                                    </div>
                                </div>
                            </div>
          ...
          foreach($categories as $category){
            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-success <?=(($category['status']=='Approved')?'disabled':'')?>"
                                                            href="?category_aprv=<?=$category['id']?>">Approve<i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-danger"
                                                            href="?category_del=<?=$category['id']?>"><?=(($category['status']=='Approved')?'Remove':'Deny')?><i
                                                                class="icon_close_alt2"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            Swal.fire({
                                                ...
                                                .then((value) => {
                                                    location.href =
                                                        'https://pdc-fallsem.42web.io/account/welcome/logout.php'
                                                });
                                        }
                                    })
                                }
