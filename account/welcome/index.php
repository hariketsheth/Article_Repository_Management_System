                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            ...
                                                            <?php if($user['role_2'] != "Contributor"){ ?><a
                                                                ...
                                                                href="manageusers.php?encryption_id"><button
                                                                    class="dropdown-item" type="button">Role:
                                                                    Contributor</button></a><?php } ?>
                                                            <?php if($user['role_2'] != "Editor"){ ?><button
                                                                class="dropdown-item" type="button">Role:
                                                                Editor</button><?php } ?>
                                                            <?php if($user['role_2'] != "Adminr"){ ?><button
                                                                class="dropdown-item" type="button">Role:
                                                                Administrator</button><?php } ?>
                                                            <?php if($user['role_1'] != "inactive"){ ?><button
                                                                class="dropdown-item" type="button">Account:
                                                                Block</button><?php } ?>
                                                            <?php if($user['role_1'] != "active"){ ?><button
                                                                class="dropdown-item" type="button">Account:
                                                                Unblock</button><?php } ?>
                                                        </div>
                                                    </div>
