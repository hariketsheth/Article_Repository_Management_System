      ...
      <div class="signin-signup">
        ...
        <form class="sign-up-form" action="signup.php" method="POST">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="First Name" autocomplete="off" autocapitalize="off" name="name1" required />
          </div>
          <div class="input-field">
            <i class="fas fa-user-circle"></i>
            <input type="text" placeholder="Full Name" autocomplete="off" autocapitalize="off" name="name2" required />
          </div>
          <div class="input-field">
            <i class="far fa-envelope"></i>
            <input type="email" placeholder="Email" autocomplete="off" autocapitalize="off" name="email1" required />
          </div>
          <div class="input-field">
          ...
          <div class="input-field">
            ...
            <input type="tel" placeholder="10-Digit Phone Number" autocomplete="off" autocapitalize="off" name="phone1" required />
