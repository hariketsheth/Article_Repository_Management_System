...
<head>
  ...
  <link rel="preload" href="assets/css/homeb222.css?v=214a6e5c0e" as="style" />
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/homeb222.css?v=214a6e5c0e" media="screen" />
...
<body class="home-template">
                            ...
                            <div class="glide__slides">
                              <?php foreach (array_slice($posts, 0, 3) as $recent) { ?>
                                <div class="glide__slide">
                                  <a href="post.php?post_link=<?= $recent['id'] ?>" class="m-recent-article">
                                    <div class="m-recent-article__picture">
                                      <img src="<?= $recent['header'] ?>" loading="lazy" alt="" onerror=this.src="../account/img/default.png" />
                                    </div>
                                    <h3 class="
                                    ...
                                    <span class="m-recent-article__date"><?= TimePost($recent['created_at']) ?></span>
                                  </a>
                                </div>
                              <?php } ?>
                            </div>
  ...
  <button type="button" class="btn btn-primary" style="background: #FF0000; color: #fff; border: none; margin: 10px;">
    <i class="fa fa-search"></i>
            ...
            <div class="m-toggle-darkmode js-tooltip" data-tippy-content="Toggle mode" tabindex="0">
  ...
  <main class="main-wrap">
    <section class="m-hero no-picture" data-aos="fade" style="background: rgba(0, 0, 0,0.7); background-image: url('https://athena-dbms.42web.io/assets/images/intro.gif'); background-blend-mode: overlay;  background-size: cover;">
      <div data-aos="fade-down" style="width: auto; max-width: 330px; left: -200px">
        <img src="../account/img/logo.png" style="
              margin: 5px;
              border-radius: 100%;
              width: 200px;
              display: block;
      ...
      <div class="m-hero__content" data-aos="fade-down" style="width: 70%;">
        ...
        <div class="m-hero-description bigger" style="color:#B4B4B4;">
          ...
          <span style="font-weight: bolder; color: #88ff00" class="typing"></span>
        </div>
        <script>
        ...
        <a href="newsletter/index.php" class="m-button filled">Stay Updated !</a>
      </div>
    </section>
    <div class="l-content">
          ...
          ?>
              <article class="m-article-card post">
                <div class="m-article-card__picture">
                  <a href="post.php?post_link=<?= $post['id'] ?>" class="m-article-card__picture-link" aria-hidden="true" tabindex="-1"></a>
                  <img class="m-article-card__picture-background" src="<?= $post['header'] ?>" loading="lazy" alt="" onerror=this.src="../account/img/default.png" />
                  <a href="author/profile.php?encryption_id=<?= $info['username'] ?>" class="m-article-card__author js-tooltip" aria-label="<?= $info['author'] ?>" data-tippy-content="Posted by <?= $info['author'] ?>">
                    <div style="background-image: url(<?= $info['photo'] ?>);"></div>
                  </a>
                </div>
                <div class="m-article-card__info">
                  <a href="tag/posts.php?category_id=<?= $post['category_id'] ?>" class="m-article-card__tag"><?= getCategory($con, $post['category_id']) ?></a>
                  <a href="post.php?post_link=<?= $post['id'] ?>" class="m-article-card__info-link" aria-label="<?= $post['title'] ?>">
                    <div>
