                ...
                <div class="l-wrapper in-post  js-aos-wrapper" data-aos="fade-up" data-aos-delay="300">
                  <div class="l-post-content  has-subscribe-form js-progress-content">
                    ...
                    <div class="pos-relative js-post-content">
                      ...
                      <div class="css-1s4b5hj">
                        <div class="css-ddoyzk"><svg class="css-1x6nj8n" viewBox="0 0 512 512">
                            <path d="M384 288h-32c-17.67 0-32 14.35-32 32.06v127.88c0 17.7 14.33 32.06 32 32.06h32c35.35 0 64-28.71 64-64.12v-63.76c0-35.41-28.65-64.12-64-64.12zm32 127.88c0 17.68-14.36 32.06-32 32.06h-32V320.06h32c17.64 0 32 14.38 32 32.06v63.76zM160 288h-32c-35.35 0-64 28.71-64 64.12v63.76C64 451.29 92.65 480 128 480h32c17.67 0 32-14.35 32-32.06V320.06c0-17.71-14.33-32.06-32-32.06zm0 159.94h-32c-17.64 0-32-14.38-32-32.06v-63.76c0-17.68 14.36-32.06 32-32.06h32v127.88zM256 32C114.84 32 0 146.85 0 288v120c0 4.42 3.58 8 8 8h16c4.42 0 8-3.58 8-8V288C32 164.48 132.5 64 256 64s224 100.48 224 224v120c0 4.42 3.58 8 8 8h16c4.42 0 8-3.58 8-8V288c0-141.15-114.84-256-256-256z"></path>
                          </svg>
                          Select Voice and Listen to this Article: <br><br><select id='voiceList'></select><br>
                          <?php
                          ...
                          <input type="hidden" id='txtInput' value=<?= $txt ?> /> <br>
                      ...
                      <div class="wrapper">
                        <?php
                        if (isset($_POST['rate1']) || isset($_POST['rate2']) || isset($_POST['rate3']) || isset($_POST['rate4']) || isset($_POST['rate5'])) {
                        }
                        ?>
                        <form action="" method="POST">
                          <input type="radio" name="rate1" id="star-1">
                          <input type="radio" name="rate2" id="star-2">
                          <input type="radio" name="rate3" id="star-3">
                          <input type="radio" name="rate4" id="star-4">
                          <input type="radio" name="rate5" id="star-5">
                          <div class="content">
                            <div class="outer">
                              <div class="emojis">
                            ...
                            <div class="stars">
                              <button type="submit" name="button" id="button" style="margin: 0px; outline: none; border: none; padding:0px; padding: 0; border: none; background: none;"><label for="star-1" class="star-1 fas fa-star"></label></button>
                              <button type="submit" name="button" id="button"><label for="star-2" class="star-2 fas fa-star"></label></button>
