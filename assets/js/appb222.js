    ...
    14: function (e, t, n) {
      ...
      a()(document).ready(function () {
        ...
        var e,
          ...
          H = function (e, t) {
            var n = new GhostContentAPI({ url: e, key: t, version: "v2" }),
              o = [],
              a = {
                shouldSort: !0,
                ignoreLocation: !0,
          ...
          P = function (e) {
            var t = a()('.js-alert[data-notification="'.concat(e, '"]'));
            t.addClass("opened"),
              setTimeout(function () {
                R(t);
              }, 5e3);
          ...
          V = function (e) {
            Object(h.isMobile)() ||
              (e
                ? (x.addClass("toggle-overflow"), _.addClass("toggle-overflow"))
                : (x.removeClass("toggle-overflow"),
                  _.removeClass("toggle-overflow")));
          };
        (i.click(function () {
          o.addClass("mobile-menu-opened"), f.addClass("opened"), E();
        }),
        d.click(function () {
          o.removeClass("mobile-menu-opened"), f.removeClass("opened"), E();
        }),
        g.click(function () {
          (A = !A)
        ...
        k.click(function () {
          C.blur(), y.removeClass("opened"), E();
        }),
        C.keyup(function () {
          if (C.val().length > 0 && L) {
            var e = L.search(C.val()).filter(function (e) {
            ...
            if (e.length > 0) {
              ...
              T.hide(), O.html(t), O.show();
            } else O.html(""), O.hide(), T.show();
          } else O.html(""), O.hide(), T.hide();
        }),
        S.change(function () {
          S.is(":checked")
        ...
        a()(window).click(function (e) {
          A && p && !p.contains(e.target) && ((A = !1), B());
        }),
        a()(document).keyup(function (e) {
          "Escape" === e.key && y.hasClass("opened") && k.click();
        }),
        I
          ? (a()("html").attr("data-theme", I),
            "dark" === I && S.attr("checked", !0))
        ...
        if (
          ...
          D = Object(c.a)(".js-open-secondary-menu", {
            content: N.innerHTML,
            allowHTML: !0,
            arrow: !0,
            trigger: "click",
        ...
        Object(c.a)(".js-tooltip"),
          ...
          "undefined" != typeof ghostSearchApiKey
            ? H(ghostHost, ghostSearchApiKey)
            : (j.css("visibility", "hidden"), k.remove(), y.remove());
      });
    },
  },
  [[13, 0, 1]],
