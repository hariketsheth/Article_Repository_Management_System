...
this._flags=this._last_last_text=this._tokens=this._output=null;this._options=new w(b)}var k=h(2).Output,n=h(3).Token,p=h(4),w=h(5).Options,x=h(7).Tokenizer,u=h(7).line_starters,y=h(7).positionable_operators,g=h(7).TOKEN,r="case return do if throw else await break continue async".split(" "),t=function(a){for(var b={},e=0;e<a.length;e++)b[a[e].replace(/-/g,"_")]=a[e];return b}(["before-newline","after-newline","preserve-newline"]),v=[t.before_newline,t.preserve_newline],m={BlockStatement:"BlockStatement",
Statement:"Statement",ObjectLiteral:"ObjectLiteral",ArrayLiteral:"ArrayLiteral",ForInitializer:"ForInitializer",Conditional:"Conditional",Expression:"Expression"};a.prototype.create_flags=function(a,b){var e=0;return a&&(e=a.indentation_level,!this._output.just_added_newline()&&a.line_indent_level>e&&(e=a.line_indent_level)),{mode:b,parent:a,last_token:a?a.last_token:new n(g.START_BLOCK,""),last_word:a?a.last_word:"",declaration_statement:!1,declaration_assignment:!1,multiline_frame:!1,inline_frame:!1,
...
c(this._flags.last_token,["var","let","const","set","get"])?this.handle_whitespace_and_comments(a):(this.handle_whitespace_and_comments(a),this.print_newline()),this._flags.do_block&&!this._flags.do_while){if(f(a,"while"))return this._output.space_before_token=!0,this.print_token(a),this._output.space_before_token=!0,void(this._flags.do_while=!0);this.print_newline();this._flags.do_block=!1}if(this._flags.if_block)if(!this._flags.else_block&&f(a,"else"))this._flags.else_block=!0;else{for(;this._flags.mode===
m.Statement;)this.restore_mode();this._flags.if_block=!1;this._flags.else_block=!1}if(this._flags.in_case_statement&&c(a,["case","default"]))return this.print_newline(),this._flags.last_token.type!==g.END_BLOCK&&(this._flags.case_body||this._options.jslint_happy)&&this.deindent(),this._flags.case_body=!1,this.print_token(a),void(this._flags.in_case=!0);if(this._flags.last_token.type!==g.COMMA&&this._flags.last_token.type!==g.START_EXPR&&this._flags.last_token.type!==g.EQUALS&&this._flags.last_token.type!==
g.OPERATOR||this.start_of_object_property()||this.allow_wrap_or_preserved_newline(a),f(a,"function"))return(d(this._flags.last_token.text,["}",";"])||this._output.just_added_newline()&&!d(this._flags.last_token.text,"([{:\x3d,".split(""))&&this._flags.last_token.type!==g.OPERATOR)&&(this._output.just_added_blankline()||a.comments_before||(this.print_newline(),this.print_newline(!0))),this._flags.last_token.type===g.RESERVED||this._flags.last_token.type===g.WORD?c(this._flags.last_token,["get","set",
"new","export"])||c(this._flags.last_token,z)?this._output.space_before_token=!0:f(this._flags.last_token,"default")&&"export"===this._last_last_text?this._output.space_before_token=!0:"declare"===this._flags.last_token.text?this._output.space_before_token=!0:this.print_newline():this._flags.last_token.type===g.OPERATOR||"\x3d"===this._flags.last_token.text?this._output.space_before_token=!0:(this._flags.multiline_frame||!e(this._flags.mode)&&this._flags.mode!==m.ArrayLiteral)&&this.print_newline(),
this.print_token(a),void(this._flags.last_word=a.text);var b="NONE";(this._flags.last_token.type===g.END_BLOCK?this._previous_flags.inline_frame?b="SPACE":c(a,["else","catch","finally","from"])?"expand"===this._options.brace_style||"end-expand"===this._options.brace_style||"none"===this._options.brace_style&&a.newlines?b="NEWLINE":(b="SPACE",this._output.space_before_token=!0):b="NEWLINE":this._flags.last_token.type===g.SEMICOLON&&this._flags.mode===m.BlockStatement?b="NEWLINE":this._flags.last_token.type===
g.SEMICOLON&&e(this._flags.mode)?b="SPACE":this._flags.last_token.type===g.STRING?b="NEWLINE":this._flags.last_token.type===g.RESERVED||this._flags.last_token.type===g.WORD||"*"===this._flags.last_token.text&&(d(this._last_last_text,["function","yield"])||this._flags.mode===m.ObjectLiteral&&d(this._last_last_text,["{",","]))?b="SPACE":this._flags.last_token.type===g.START_BLOCK?b=this._flags.inline_frame?"SPACE":"NEWLINE":this._flags.last_token.type===g.END_EXPR&&(this._output.space_before_token=
!0,b="NEWLINE"),c(a,u)&&")"!==this._flags.last_token.text&&(b=this._flags.inline_frame||"else"===this._flags.last_token.text||"export"===this._flags.last_token.text?"SPACE":"NEWLINE"),c(a,["else","catch","finally"]))?(this._flags.last_token.type!==g.END_BLOCK||this._previous_flags.mode!==m.BlockStatement||"expand"===this._options.brace_style||"end-expand"===this._options.brace_style||"none"===this._options.brace_style&&a.newlines)&&!this._flags.inline_frame?this.print_newline():(this._output.trim(!0),
"}"!==this._output.current_line.last()&&this.print_newline(),this._output.space_before_token=!0):"NEWLINE"===b?c(this._flags.last_token,r)?this._output.space_before_token=!0:"declare"===this._flags.last_token.text&&c(a,["var","let","const"])?this._output.space_before_token=!0:this._flags.last_token.type!==g.END_EXPR?this._flags.last_token.type===g.START_EXPR&&c(a,["var","let","const"])||":"===this._flags.last_token.text||(f(a,"if")&&f(a.previous,"else")?this._output.space_before_token=!0:this.print_newline()):
c(a,u)&&")"!==this._flags.last_token.text&&this.print_newline():this._flags.multiline_frame&&this._flags.mode===m.ArrayLiteral&&","===this._flags.last_token.text&&"}"===this._last_last_text?this.print_newline():"SPACE"===b&&(this._output.space_before_token=!0);!a.previous||a.previous.type!==g.WORD&&a.previous.type!==g.RESERVED||(this._output.space_before_token=!0);this.print_token(a);this._flags.last_word=a.text;a.type===g.RESERVED&&("do"===a.text?this._flags.do_block=!0:"if"===a.text?this._flags.if_block=
!0:"import"===a.text?this._flags.import_block=!0:this._flags.import_block&&f(a,"from")&&(this._flags.import_block=!1))};a.prototype.handle_semicolon=function(a){this.start_of_statement(a)?this._output.space_before_token=!1:this.handle_whitespace_and_comments(a);for(var b=this._tokens.peek();!(this._flags.mode!==m.Statement||this._flags.if_block&&f(b,"else")||this._flags.do_block);)this.restore_mode();this._flags.import_block&&(this._flags.import_block=!1);this.print_token(a)};a.prototype.handle_string=
function(a){this.start_of_statement(a)?this._output.space_before_token=!0:(this.handle_whitespace_and_comments(a),this._flags.last_token.type===g.RESERVED||this._flags.last_token.type===g.WORD||this._flags.inline_frame?this._output.space_before_token=!0:this._flags.last_token.type===g.COMMA||this._flags.last_token.type===g.START_EXPR||this._flags.last_token.type===g.EQUALS||this._flags.last_token.type===g.OPERATOR?this.start_of_object_property()||this.allow_wrap_or_preserved_newline(a):this.print_newline());
this.print_token(a)};a.prototype.handle_equals=function(a){this.start_of_statement(a)||this.handle_whitespace_and_comments(a);this._flags.declaration_statement&&(this._flags.declaration_assignment=!0);this._output.space_before_token=!0;this.print_token(a);this._output.space_before_token=!0};a.prototype.handle_comma=function(a){this.handle_whitespace_and_comments(a,!0);this.print_token(a);this._output.space_before_token=!0;this._flags.declaration_statement?(e(this._flags.parent.mode)&&(this._flags.declaration_assignment=
!1),this._flags.declaration_assignment?(this._flags.declaration_assignment=!1,this.print_newline(!1,!0)):this._options.comma_first&&this.allow_wrap_or_preserved_newline(a)):this._flags.mode===m.ObjectLiteral||this._flags.mode===m.Statement&&this._flags.parent.mode===m.ObjectLiteral?(this._flags.mode===m.Statement&&this.restore_mode(),this._flags.inline_frame||this.print_newline()):this._options.comma_first&&this.allow_wrap_or_preserved_newline(a)};a.prototype.handle_operator=function(a){var b="*"===
...
var e=this.current_line.pop();e&&("\n"===e[e.length-1]&&(e=e.replace(/\n+$/g,"")),this.current_line.push(e));this._end_with_newline&&this.__add_outputline();e=this.__lines.join("\n");return"\n"!==b&&(e=e.replace(/[\n]/g,b)),e};c.prototype.set_wrap_point=function(){this.current_line._set_wrap_point()};c.prototype.set_indent=function(b,e){return b=b||0,e=e||0,this.next_line.set_indent(b,e),1<this.__lines.length?(this.current_line.set_indent(b,e),!0):(this.current_line.set_indent(),!1)};c.prototype.add_raw_token=
function(b){for(var e=0;e<b.newlines;e++)this.__add_outputline();this.current_line.set_indent(-1);this.current_line.push(b.whitespace_before);this.current_line.push(b.text);this.previous_token_wrapped=this.non_breaking_space=this.space_before_token=!1};c.prototype.add_token=function(b){this.__add_space_before_token();this.current_line.push(b);this.non_breaking_space=this.space_before_token=!1;this.previous_token_wrapped=this.current_line._allow_wrap()};c.prototype.__add_space_before_token=function(){this.space_before_token&&
...
this._get_number("max_char"));this.indent_empty_lines=this._get_boolean("indent_empty_lines");this.templating=this._get_selection_list("templating","auto none django erb handlebars php".split(" "),["auto"])}function f(b,e){var a={};b=c(b);for(var k in b)k!==e&&(a[k]=b[k]);if(e&&b[e])for(k in b[e])a[k]=b[e][k];return a}function c(b){var e,a={};for(e in b)a[e.replace(/-/g,"_")]=b[e];return a}d.prototype._get_array=function(b,e){var a=this.raw_options[b],c=e||[];return"object"==typeof a?null!==a&&"function"==
typeof a.concat&&(c=a.concat()):"string"==typeof a&&(c=a.split(/[^a-zA-Z0-9_\/\-]+/)),c};d.prototype._get_boolean=function(b,e){var a=this.raw_options[b];return void 0===a?!!e:!!a};d.prototype._get_characters=function(b,e){var a=this.raw_options[b],c=e||"";return"string"==typeof a&&(c=a.replace(/\\r/,"\r").replace(/\\n/,"\n").replace(/\\t/,"\t")),c};d.prototype._get_number=function(b,e){var a=this.raw_options[b];e=parseInt(e,10);isNaN(e)&&(e=0);a=parseInt(a,10);return isNaN(a)&&(a=e),a};d.prototype._get_selection=
function(b,e,a){a=this._get_selection_list(b,e,a);if(1!==a.length)throw Error("Invalid Option Value: The option '"+b+"' can only be one of the following values:\n"+e+"\nYou passed in: '"+this.raw_options[b]+"'");return a[0]};d.prototype._get_selection_list=function(b,e,a){if(!e||0===e.length)throw Error("Selection list cannot be empty.");if(a=a||[e[0]],!this._is_valid_selection(a,e))throw Error("Invalid Default Value!");a=this._get_array(b,a);if(!this._is_valid_selection(a,e))throw Error("Invalid Option Value: The option '"+
b+"' can contain only the following values:\n"+e+"\nYou passed in: '"+this.raw_options[b]+"'");return a};d.prototype._is_valid_selection=function(b,e){return b.length&&e.length&&!b.some(function(a){return-1===e.indexOf(a)})};q.exports.Options=d;q.exports.normalizeOpts=c;q.exports.mergeOpts=f},function(q,l,h){function d(a,b){return-1!==b.indexOf(a)}var f=h(8).InputScanner,c=h(9).Tokenizer;l=h(9).TOKEN;var b=h(13).Directives,e=h(4),a=h(12).Pattern,k=h(14).TemplatablePattern,n={START_EXPR:"TK_START_EXPR",
END_EXPR:"TK_END_EXPR",START_BLOCK:"TK_START_BLOCK",END_BLOCK:"TK_END_BLOCK",WORD:"TK_WORD",RESERVED:"TK_RESERVED",SEMICOLON:"TK_SEMICOLON",STRING:"TK_STRING",EQUALS:"TK_EQUALS",OPERATOR:"TK_OPERATOR",COMMA:"TK_COMMA",BLOCK_COMMENT:"TK_BLOCK_COMMENT",COMMENT:"TK_COMMENT",DOT:"TK_DOT",UNKNOWN:"TK_UNKNOWN",START:l.START,RAW:l.RAW,EOF:l.EOF},p=new b(/\/\*/,/\*\//),w=/0[xX][0123456789abcdefABCDEF]*|0[oO][01234567]*|0[bB][01]*|\d+n|(?:\.\d+|\d+\.?\d*)(?:[eE][+-]?\d+)?/,x=/[0-9]/,u=/[^\d\.]/;h="\x3e\x3e\x3e\x3d ... \x3e\x3e\x3d \x3c\x3c\x3d \x3d\x3d\x3d \x3e\x3e\x3e !\x3d\x3d **\x3d \x3d\x3e ^\x3d :: /\x3d \x3c\x3c \x3c\x3d \x3d\x3d \x26\x26 -\x3d \x3e\x3d \x3e\x3e !\x3d -- +\x3d ** || ?? ++ %\x3d \x26\x3d *\x3d |\x3d |\x3e \x3d ! ? \x3e \x3c : / ^ - + * \x26 % ~ |".replace(/[-[\]{}()*+?.,\\^$|#]/g,
"\\$\x26");h=("\\?\\.(?!\\d) "+h).replace(/ /g,"|");var r,g=new RegExp(h);h="continue try throw return var let const if switch case default for while break function import export".split(" ");l=h.concat("do in of else get set new catch finally typeof yield async await from as".split(" "));var A=new RegExp("^(?:"+l.join("|")+")$");l=function(b,v){c.call(this,b,v);this._patterns.whitespace=this._patterns.whitespace.matching(/\u00A0\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff/.source,/\u2028\u2029/.source);
var m=new a(this._input),d=(new k(this._input)).read_options(this._options);this.__patterns={template:d,identifier:d.starting_with(e.identifier).matching(e.identifierMatch),number:m.matching(w),punct:m.matching(g),comment:m.starting_with(/\/\//).until(/[\n\r\u2028\u2029]/),block_comment:m.starting_with(/\/\*/).until_after(/\*\//),html_comment_start:m.matching(/\x3c!--/),html_comment_end:m.matching(/--\x3e/),include:m.starting_with(/#include/).until_after(e.lineBreak),shebang:m.starting_with(/#!/).until_after(e.lineBreak),
xml:m.matching(/[\s\S]*?<(\/?)([-a-zA-Z:0-9_.]+|{[\s\S]+?}|!\[CDATA\[[\s\S]*?\]\])(\s+{[\s\S]+?}|\s+[-a-zA-Z:0-9_.]+|\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{[\s\S]+?}))*\s*(\/?)\s*>/),single_quote:d.until(/['\\\n\r\u2028\u2029]/),double_quote:d.until(/["\\\n\r\u2028\u2029]/),template_text:d.until(/[`\\$]/),template_expression:d.until(/[`}\\]/)}};l.prototype=new c;l.prototype._is_comment=function(a){return a.type===n.COMMENT||a.type===n.BLOCK_COMMENT||a.type===n.UNKNOWN};l.prototype._is_opening=
...
function(){return this.__position<this.__tokens_length};d.prototype.next=function(){var d=null;return this.hasNext()&&(d=this.__tokens[this.__position],this.__position+=1),d};d.prototype.peek=function(d){var c=null;return d=d||0,d+=this.__position,0<=d&&d<this.__tokens_length&&(c=this.__tokens[d]),c};d.prototype.add=function(d){this.__parent_token&&(d.parent=this.__parent_token);this.__tokens.push(d);this.__tokens_length+=1};q.exports.TokenStream=d},function(q,l,h){function d(c,b){f.call(this,c,b);
b?this._line_regexp=this._input.get_regexp(b._line_regexp):this.__set_whitespace_patterns("","");this.newline_count=0;this.whitespace_before_token=""}var f=h(12).Pattern;d.prototype=new f;d.prototype.__set_whitespace_patterns=function(c,b){b+="\\n\\r";this._match_pattern=this._input.get_regexp("["+(c+"\\t ")+b+"]+",!0);this._newline_regexp=this._input.get_regexp("\\r\\n|["+b+"]")};d.prototype.read=function(){this.newline_count=0;this.whitespace_before_token="";var c=this._input.read(this._match_pattern);
if(" "===c)this.whitespace_before_token=" ";else if(c){var b=this.__split(this._newline_regexp,c);this.newline_count=b.length-1;this.whitespace_before_token=b[this.newline_count]}return c};d.prototype.matching=function(c,b){var e=this._create();return e.__set_whitespace_patterns(c,b),e._update(),e};d.prototype._create=function(){return new d(this._input,this)};d.prototype.__split=function(c,b){for(var e=c.lastIndex=0,a=[],d=c.exec(b);d;)a.push(b.substring(e,d.index)),e=d.index+d[0].length,d=c.exec(b);
return e<b.length?a.push(b.substring(e,b.length)):a.push(""),a};q.exports.WhitespacePattern=d},function(q,l,h){function d(d,c){this._input=d;this._until_pattern=this._match_pattern=this._starting_pattern=null;this._until_after=!1;c&&(this._starting_pattern=this._input.get_regexp(c._starting_pattern,!0),this._match_pattern=this._input.get_regexp(c._match_pattern,!0),this._until_pattern=this._input.get_regexp(c._until_pattern),this._until_after=c._until_after)}d.prototype.read=function(){var d=this._input.read(this._starting_pattern);
return this._starting_pattern&&!d||(d+=this._input.read(this._match_pattern,this._until_pattern,this._until_after)),d};d.prototype.read_match=function(){return this._input.match(this._match_pattern)};d.prototype.until_after=function(d){var c=this._create();return c._until_after=!0,c._until_pattern=this._input.get_regexp(d),c._update(),c};d.prototype.until=function(d){var c=this._create();return c._until_after=!1,c._until_pattern=this._input.get_regexp(d),c._update(),c};d.prototype.starting_with=function(d){var c=
this._create();return c._starting_pattern=this._input.get_regexp(d,!0),c._update(),c};d.prototype.matching=function(d){var c=this._create();return c._match_pattern=this._input.get_regexp(d,!0),c._update(),c};d.prototype._create=function(){return new d(this._input,this)};d.prototype._update=function(){};q.exports.Pattern=d},function(q,l,h){function d(d,c){d="string"==typeof d?d:d.source;c="string"==typeof c?c:c.source;this.__directives_block_pattern=new RegExp(d+/ beautify( \w+[:]\w+)+ /.source+c,
"g");this.__directive_pattern=/ (\w+)[:](\w+)/g;this.__directives_end_ignore_pattern=new RegExp(d+/\sbeautify\signore:end\s/.source+c,"g")}d.prototype.get_directives=function(d){if(!d.match(this.__directives_block_pattern))return null;var c={};this.__directive_pattern.lastIndex=0;for(var b=this.__directive_pattern.exec(d);b;)c[b[1]]=b[2],b=this.__directive_pattern.exec(d);return c};d.prototype.readIgnored=function(d){return d.readUntilAfter(this.__directives_end_ignore_pattern)};q.exports.Directives=
d},function(q,l,h){function d(b,e){f.call(this,b,e);this.__template_pattern=null;this._disabled=Object.assign({},c);this._excluded=Object.assign({},c);e&&(this.__template_pattern=this._input.get_regexp(e.__template_pattern),this._excluded=Object.assign(this._excluded,e._excluded),this._disabled=Object.assign(this._disabled,e._disabled));var a=new f(b);this.__patterns={handlebars_comment:a.starting_with(/{{!--/).until_after(/--}}/),handlebars_unescaped:a.starting_with(/{{{/).until_after(/}}}/),handlebars:a.starting_with(/{{/).until_after(/}}/),
php:a.starting_with(/<\?(?:[=]|php)/).until_after(/\?>/),erb:a.starting_with(/<%[^%]/).until_after(/[^%]%>/),django:a.starting_with(/{%/).until_after(/%}/),django_value:a.starting_with(/{{/).until_after(/}}/),django_comment:a.starting_with(/{#/).until_after(/#}/)}}var f=h(12).Pattern,c={django:!1,erb:!1,handlebars:!1,php:!1};d.prototype=new f;d.prototype._create=function(){return new d(this._input,this)};d.prototype._update=function(){this.__set_templated_pattern()};d.prototype.disable=function(b){var e=
...
b){var e=this.__base_string_length;return b=b||0,0>a&&(e=0),e+=a*this.__indent_size,e+b};b.prototype.get_indent_string=function(a,b){var e=this.__base_string;return b=b||0,0>a&&(a=0,e=""),b+=a*this.__indent_size,this.__ensure_cache(b),e+this.__cache[b]};b.prototype.__ensure_cache=function(a){for(;a>=this.__cache.length;)this.__add_column()};b.prototype.__add_column=function(){var a=this.__cache.length,b=0,e="";this.__indent_size&&a>=this.__indent_size&&(b=Math.floor(a/this.__indent_size),a-=b*this.__indent_size,
...
((this._is_wrap_attributes_preserve||this._is_wrap_attributes_preserve_aligned)&&(a.traverse_whitespace(b),d=d||0!==b.newlines),this._is_wrap_attributes_force)){var g=1<c.attr_count;if(this._is_wrap_attributes_force_expand_multiline&&1===c.attr_count){var h,g=!0,k=0;do{if(h=e.peek(k),h.type===p.ATTRIBUTE){g=!1;break}k+=1}while(4>k&&h.type!==p.EOF&&h.type!==p.TAG_CLOSE);g=!g}g&&(a.print_newline(!1),d=!0)}a.print_token(b);d=d||a.previous_token_wrapped();c.has_wrapped_attrs=d}return f};e.prototype._handle_text=
...
a.print_newline(!1)),this._tag_stack.record_tag(c),!("script"!==c.tag_name&&"style"!==c.tag_name||c.is_unformatted||c.is_content_unformatted)){var f=c.tag_check,g=null,h=null;if(b.closed){"script"===f?g="text/javascript":"style"===f&&(g="text/css");for(var f=null,k=b.next;k.type!==p.EOF&&b.closed!==k;){if(k.type===p.ATTRIBUTE&&"type"===k.text){k.next&&k.next.type===p.EQUALS&&k.next.next&&k.next.next.type===p.VALUE&&(f=k.next.next.text);break}k=k.next}b=(g=f||g,-1<g.search("text/css")?h="css":-1<g.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/)?
